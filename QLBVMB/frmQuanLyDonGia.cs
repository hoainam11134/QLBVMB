    ...
    public partial class frmQuanLyDonGia : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (cboMaTuyenBay.Text.Trim() != "" && cboMaHangVe.Text.Trim() != "" && txtDonGia.Text!="")
            {
                ...
                try
                {
                    ...
                    double giaThuongGia = dongia * 1.05;
                    ...
                    {
                        int maHV = Convert.ToInt32(cboMaHangVe.SelectedValue);
                        maHV = maHV + 1;
                        dtoDonGia2 = new DTO_DonGia(cboMaTuyenBay.Text, maHV.ToString(), Convert.ToInt32(giaThuongGia));
                        busDonGia.Add(dtoDonGia2);
        ...
        private void cboMaTuyenBay_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            if (dtTuyenBay.Rows.Count == 0)
                MessageBox.Show("Vui lòng chọn tuyến bay!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            else
            {
        ...
        private void txtDonGia_TextChanged(object sender, EventArgs e)
        {
            ...
            if(System.Text.RegularExpressions.Regex.IsMatch(txtDonGia.Text, "^[0-9]*$"))
            {
